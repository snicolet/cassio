...
function MinimisationParBrentAvecDerivee(derivationNumerique : boolean; f : FonctionReelle; {calcul de f} diff : DifferentielleReelle; {calcul simultanŽ de f et de f' : passer bidDiff si l'on veut utiliser la derivation numŽriqe} ax,bx,cx,tol : TypeReel; var xmin : TypeReel) : TypeReel;                                                                         ATTRIBUTE_NAME('MinimisationParBrentAvecDerivee')
