...
var dp : DialogPtr;
    ...
    err : OSErr;
    CoeffinfluenceArrivee : double_t;
    CoefffrontiereArrivee : double_t;
    CoeffEquivalenceArrivee : double_t;
    CoeffcentreArrivee : double_t;
    CoeffgrandcentreArrivee : double_t;
    CoeffdispersionArrivee : double_t;
    CoeffminimisationArrivee : double_t;
    CoeffpriseCoinArrivee : double_t;
    CoeffdefenseCoinArrivee : double_t;
    CoeffValeurCoinArrivee : double_t;
    CoeffValeurCaseXArrivee : double_t;
    CoeffPenaliteArrivee : double_t;
    CoeffMobiliteUnidirectionnelleArrivee : double_t;
