...
begin
  ...
  texte := ReplaceStringOnce('PrŽvenez StŽphane, SVP !','',texte);
  texte := ReplaceStringOnce('Prevenez StŽphane','',texte);
  texte := ReplaceStringOnce('PrŽvenez StŽphane','',texte);
  texte := ReplaceStringOnce('PrŽvŽnez StŽphane','',texte);
  texte := ReplaceStringOnce('Sauvegardez le rapport et prŽvenez StŽphane','',texte);
  texte := ReplaceStringOnce(',prŽvenez StŽphane','',texte);
  texte := ReplaceStringOnce(', prŽvenez StŽphane','',texte);
  texte := ReplaceStringOnce('(prŽvenez StŽphane)','',texte);
  texte := ReplaceStringOnce('Merci de prŽvenir StŽphane','',texte);

  texte := ReplaceStringOnce('PrŽvenez Stephane, SVP !','',texte);
  texte := ReplaceStringOnce('Prevenez Stephane','',texte);
  texte := ReplaceStringOnce('PrŽvenez Stephane','',texte);
  texte := ReplaceStringOnce('PrŽvŽnez Stephane','',texte);
  texte := ReplaceStringOnce('Sauvegardez le rapport et prŽvenez Stephane','',texte);
  texte := ReplaceStringOnce(',prŽvenez Stephane','',texte);
  texte := ReplaceStringOnce(', prŽvenez Stephane','',texte);
  texte := ReplaceStringOnce('(prŽvenez Stephane)','',texte);
  texte := ReplaceStringOnce('Merci de prŽvenir Stephane','',texte);

  texte := ReplaceStringOnce('Prevenez StŽphane, SVP !','',texte);
  texte := ReplaceStringOnce('Prevenez StŽphane','',texte);
  texte := ReplaceStringOnce('PrevŽnez StŽphane','',texte);
  texte := ReplaceStringOnce('Sauvegardez le rapport et prevenez StŽphane','',texte);
  texte := ReplaceStringOnce(',prevenez StŽphane','',texte);
  texte := ReplaceStringOnce(', prevenez StŽphane','',texte);
  texte := ReplaceStringOnce('(prevenez StŽphane)','',texte);
  texte := ReplaceStringOnce('Merci de prŽvenir StŽphane','',texte);
