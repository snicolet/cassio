...
function WritePositionEtTraitEnEPSDansFichier(position : PositionEtTraitRec; fic : FichierTEXT) : OSErr;                                                                            ATTRIBUTE_NAME('WritePositionEtTraitEnEPSDansFichier')


function WritePrologueEPSDansFichier(var fic : FichierAbstrait; nomFichier : String255) : OSErr;                                                                                    ATTRIBUTE_NAME('WritePrologueEPSDansFichier')
