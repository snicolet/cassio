...
begin
  with cellule do
    begin
       ...
       MY_SWAP_INTEGER( @valeurMinimax);              (* appartient à {Gain,Nulle,Perte,PasDansArbre,etc.} *)
       MY_SWAP_INTEGER( @numeroDuCoup);               (* 1 à 60 *)
       MY_SWAP_INTEGER( @VersionEtProfondeur);        (* version appartient à {kCassio,kYapp,etc.}, profondeur de la recherche heuristique appartient à [0..30] *)
       ...
       MY_SWAP_INTEGER( @ValeurDeviantePourNoir);     (* appartient à [-6400..+6400] *)
       MY_SWAP_INTEGER( @ValeurDeviantePourBlanc);    (* appartient à [-6400..+6400] *)
       ...
       MY_SWAP_INTEGER( @ValeurHeuristiquePourNoir);  (* appartient à [-6400..+6400] ; attention : toujours pour les Noirs *)
