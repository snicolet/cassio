...
begin
  ...
  if nbreErreursDeTypes <> 0 then
    begin
      WritelnDansRapport('');
      WritelnDansRapport('Il y a '+NumEnString(nbreErreursDeTypes) +' types qui ont des tailles différentes dans CodeWarrior et GNU Pascal');
      WritelnDansRapport('');
    end;
...
(* initialisation de l'unite UnitDefFichiersTEXT et des handlers associes *)
  ...
  InstalleMessageAndNumDisplayerFichierTexte(WritelnNumDansRapportOuvert);
