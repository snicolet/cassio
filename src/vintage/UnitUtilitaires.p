    ...
    begin
      if (i mod 10) = 1 then
        begin
          ...
          WritelnDansRapport('matrice unit� pour i = '+NumEnString(i)+' : ');
...
begin
  if (gClefHashage <> valeurCorrecte) then
    begin
      ...
      AlerteSimple('Erreur dans mon algorithme, gClefHashage = '+NumEnString(gClefHashage)+ ' dans '+nomFonction+'!! Pr�venez St�phane');
    end;
end;
